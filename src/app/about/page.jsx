    ...
    <div className="bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <main className="isolate">
        ...
        <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:mt-8">
          <div className="w-full">
            <h2 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 sm:text-4xl">
              Our Mission
            </h2>
            <div className="mt-6">
              <div className="w-full">
        ...
        <div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
          <h2 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 sm:text-4xl mb-12">
            Our Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group">
              ...
              />
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Luxury Villa Interior</h3>
              <p className="text-sm text-gray-600">Residential Project</p>
            </div>
            <div className="group">
              <img
                ...
                className="aspect-[4/3] w-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow duration-300"
              />
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Modern Office Complex</h3>
              <p className="text-sm text-gray-600">Commercial Project</p>
            </div>
            <div className="group">
              <img
                ...
                className="aspect-[4/3] w-full object-cover rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow duration-300"
              />
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Eco-Friendly Development</h3>
              <p className="text-sm text-gray-600">Urban Planning Project</p>
            </div>
          </div>
        </div>
